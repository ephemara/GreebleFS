...
- serves `AGENT_USAGE.md` through `gfs_how_to_use` and the `manual://gfs-dev-mcp/how-to-use` resource so agents get usage guidance without bloating every tool description
