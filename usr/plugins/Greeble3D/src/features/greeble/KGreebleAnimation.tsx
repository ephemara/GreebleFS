...
export default function KGreebleAnimation({
    ...
    stopPlay: _stopPlay,
    handleTimelineScrub: _handleTimelineScrub,
    handleSliderChange: _handleSliderChange,
    handleSliderUp: _handleSliderUp,
    keyframes: _keyframes,
    handleAddKeyframe: _handleAddKeyframe,
    handleDeleteKeyframe: _handleDeleteKeyframe,
    ...
    return (
        <>
            ...
            <section className="flex flex-col h-full">
                ...
                <div className="bg-[#161616] border border-pink-900/30 rounded-xl p-4 flex flex-col gap-4">
                    {selectedObjectUUID ? (
                        <>
                            ...
                            <div className="space-y-4">
                                <div className="pb-3 mb-3 border-b border-[#222] text-[10px] text-blue-300 italic text-center flex items-center justify-center gap-2 bg-blue-900/10 rounded p-2">
            ...
            {/* FLOATING TIMELINE (Rendered via Portal in Parent ideally, but passed as Fragment here to be placed in UI) */}
        </>
    );
}
...
export function KGreebleTimeline({
    ...
    return (
        <div className="absolute bottom-6 left-6 right-6 h-32 bg-[#111]/90 backdrop-blur-md border border-[#333] rounded-xl flex flex-col shadow-2xl overflow-hidden animate-in slide-in-from-bottom-4 duration-300 z-50">
