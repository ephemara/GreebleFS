...
Owns regression hunting, flaky state cleanup, performance tracking, crash recovery, targeted tests, and making sure aggressive coding does not quietly break the product.
