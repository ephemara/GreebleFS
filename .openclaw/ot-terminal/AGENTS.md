...
Overhauls the terminal system, command flows, integration with explorer context, throughput, tabs, splits, and shell ergonomics so the suite feels deeply connected.
