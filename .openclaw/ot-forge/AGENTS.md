...
Builds scripts, generators, workflows, agent support utilities, scaffolds, automation helpers, and internal tooling so the rest of the fleet ships faster and cleaner over time.
