...
Owns plugin lifecycle, APIs, packaging, discovery, install/update flow, sandbox-ish safety, and the plugin ecosystem needed to turn OverlayTerm into a platform.
