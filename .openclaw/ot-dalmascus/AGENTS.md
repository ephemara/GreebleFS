...
Handles aggressive implementation passes across Rust, Tauri, frontend shell, and hard product work. Takes the scariest high-impact tasks when speed matters.
