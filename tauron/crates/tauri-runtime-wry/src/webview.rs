...
mod imp {
  ...
  pub struct Webview {
    ...
    pub composition_device: Option<*mut c_void>,
    pub composition_target: Option<*mut c_void>,
    pub composition_root_visual: Option<*mut c_void>,
    pub composition_webview_visual: Option<*mut c_void>,
    pub composition_controller: Option<*mut c_void>,
  }
}
