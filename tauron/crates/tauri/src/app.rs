...
impl<R: Runtime> App<R> {
  ...
  fn register_core_plugins(&self) -> crate::Result<()> {
    ...
    self.handle.plugin(crate::transport::plugin())?;
    self.handle.plugin(crate::native_control::plugin())?;
    self.handle.plugin(crate::native_stream::plugin())?;
    self.handle.plugin(crate::dev_observatory::plugin())?;
