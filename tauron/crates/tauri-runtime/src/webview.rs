...
use http::Request;
#[cfg(windows)]
use tauri_utils::config::WindowsWebview2VisualHostingMode as ConfigWindowsWebview2VisualHostingMode;
...
/// The Windows WebView2 visual hosting mode.
///
/// This controls whether WebView2 is attached through its regular HWND-backed controller or through
/// its DirectComposition-backed composition controller. It does not make WebView2 render through
/// wgpu; WebView2 still owns DOM, layout and rasterization.
#[cfg(windows)]
#[derive(Debug, Clone, Copy, Default, PartialEq, Eq)]
pub enum WindowsWebview2VisualHostingMode {
  #[default]
  /// Use WebView2's default HWND-backed controller.
  Hwnd,
  /// Use WebView2's composition controller.
...
pub struct WebviewAttributes {
  ...
  #[cfg(windows)]
  pub windows_webview2_visual_hosting_mode: WindowsWebview2VisualHostingMode,
...
impl From<&WindowConfig> for WebviewAttributes {
  fn from(config: &WindowConfig) -> Self {
    ...
    {
      builder =
        builder.windows_webview2_visual_hosting_mode(match config.webview2_visual_hosting_mode {
          ConfigWindowsWebview2VisualHostingMode::Hwnd => WindowsWebview2VisualHostingMode::Hwnd,
          ConfigWindowsWebview2VisualHostingMode::CompositionController => {
            WindowsWebview2VisualHostingMode::CompositionController
          }
          _ => WindowsWebview2VisualHostingMode::Hwnd,
        });
    }
...
impl WebviewAttributes {
  ...
  pub fn new(url: WebviewUrl) -> Self {
    Self {
      ...
      #[cfg(windows)]
      windows_webview2_visual_hosting_mode: WindowsWebview2VisualHostingMode::Hwnd,
  ...
  /// [`WindowsWebview2VisualHostingMode::CompositionController`] when the native side needs
  /// DirectComposition visual hosting.
  #[cfg(windows)]
  #[must_use]
  pub fn windows_webview2_visual_hosting_mode(
    ...
    self.windows_webview2_visual_hosting_mode = mode;
    self
  }
