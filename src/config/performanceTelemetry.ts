...
export const explorerPerformanceBudgets = {
  ...
  explorer_drag_pointer_frame: {
    ...
    targetMs: 4,
    description: 'Pointer normalization, hit-test, validation, and shared drag-state publish for one Explorer drag frame.',
  },
  explorer_drag_hit_test: {
    label: 'Drag Hit Test',
    targetMs: 2,
    description: 'Drop-surface target resolution for one Explorer drag pointer sample.',
  },
  explorer_drag_overlay_present: {
    label: 'Drag Overlay Present',
    targetMs: 8.3,
    description: 'Rendered Explorer drag overlay presentation update.',
  },
  explorer_drag_autoscroll_step: {
    label: 'Drag Autoscroll Step',
    targetMs: 4,
    description: 'Explorer viewport autoscroll step while an internal pointer drag is active.',
  },
  explorer_drag_native_bridge_start: {
    label: 'Native Drag Bridge',
    targetMs: 16,
    description: 'Request path for starting native OS file drag-out through the Tauri bridge.',
  },
  explorer_drag_drop_commit: {
    label: 'Drag Drop Commit',
    targetMs: 120,
    description: 'Frontend request/commit path for a completed Explorer drag/drop transfer.',
  },
  overlay_frame_time: {
...
function createMetricRecord<T>(factory: (metricId: ExplorerPerformanceMetricId) => T): Record<ExplorerPerformanceMetricId, T> {
  return {
    ...
    explorer_drag_autoscroll_step: factory('explorer_drag_autoscroll_step'),
    explorer_drag_native_bridge_start: factory('explorer_drag_native_bridge_start'),
    explorer_drag_drop_commit: factory('explorer_drag_drop_commit'),
