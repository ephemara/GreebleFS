...
export function resolveExplorerThemeRecipe(
  ...
  const cssVars = {
    ...
    '--overlay-explorer-command-bg': 'transparent',
    '--overlay-explorer-command-hover-bg': 'color-mix(in srgb, var(--overlay-explorer-chip-active-bg) 74%, transparent)',
    '--overlay-explorer-command-active-bg': 'color-mix(in srgb, var(--overlay-explorer-chip-active-bg) 82%, transparent)',
    '--overlay-explorer-command-active-text': 'var(--overlay-explorer-chip-active-text)',
