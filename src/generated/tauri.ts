...
export type ExplorerThumbnailArtifact = { entityId: string; contentRevision: string; kind: ExplorerThumbnailKind; posterPath: string; hoverFramePaths: string[]; hoverFrameDelayMs: number | null }
...
export type PythonSidecarActionRequest = { config: PythonRuntimeConfig | null; actionId: string; payloadJson: string | null; workingDirectory: string | null; environment: Partial<{ [key in string]: string }> | null; startIfNeeded: boolean | null }
export type PythonSidecarActionResponse = { runtimeStatus: PythonRuntimeStatus; sidecar: PythonSidecarStatus; requestId: string; actionId: string; resultJson: string }
