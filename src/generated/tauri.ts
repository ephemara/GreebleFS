...
export type ImageCutoutSessionOpenRequest = { inputPath: string | null; inputDataUrl: string | null; logicalOutputPath: string | null; previewMaxDimension: number | null; config: PythonRuntimeConfig | null; modelId: string | null; backendPreference: string | null }
