...
async ipcRegisterArtifactPath(request: IpcRegisterArtifactPathRequest) : Promise<Result<IpcArtifactDescriptor, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("ipc_register_artifact_path", { request }) };
} catch (e) {
...
async pathIndexGetStatus() : Promise<Result<PathIndexStatus, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("path_index_get_status") };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async pathIndexStart(request: PathIndexStartRequest) : Promise<Result<PathIndexStartResponse, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("path_index_start", { request }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async pathIndexListDir(request: PathIndexListDirectoryRequest) : Promise<Result<FileEntry[], string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("path_index_list_dir", { request }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async pathIndexSearch(request: PathIndexSearchRequest) : Promise<Result<FileEntry[], string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("path_index_search", { request }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async pathIndexAccelerationStatus() : Promise<Result<PathIndexAccelerationStatus, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("path_index_acceleration_status") };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async pathIndexAccelerationEnable(request: PathIndexAccelerationEnableRequest) : Promise<Result<PathIndexAccelerationEnableResponse, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("path_index_acceleration_enable", { request }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async pathIndexAccelerationRebuild(request: PathIndexAccelerationRebuildRequest) : Promise<Result<PathIndexAccelerationEnableResponse, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("path_index_acceleration_rebuild", { request }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async pathIndexAccelerationInstallService(request: PathIndexAccelerationInstallServiceRequest) : Promise<Result<PathIndexAccelerationInstallServiceResponse, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("path_index_acceleration_install_service", { request }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
...
async globalSearchQueryIndex(request: GlobalSearchIndexQueryRequest) : Promise<Result<GlobalSearchResultEntry[], string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("global_search_query_index", { request }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async globalSearchQueryIndexPage(request: GlobalSearchIndexQueryRequest) : Promise<Result<GlobalSearchIndexQueryResponse, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("global_search_query_index_page", { request }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
...
async runtimeListPackages(request: RuntimeListPackagesRequest | null) : Promise<Result<RuntimeListPackagesResponse, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("runtime_list_packages", { request }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async runtimeGetToolchainStatus() : Promise<Result<RuntimeToolchainStatus, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("runtime_get_toolchain_status") };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async runtimePreparePackage(request: RuntimePreparePackageRequest) : Promise<Result<RuntimePreparePackageResponse, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("runtime_prepare_package", { request }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async runtimeStartSidecar(request: RuntimeStartSidecarRequest) : Promise<Result<ExternalRuntimeSidecarStatus, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("runtime_start_sidecar", { request }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async runtimeStopSidecar(request: RuntimeStopSidecarRequest) : Promise<Result<ExternalRuntimeSidecarStatus, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("runtime_stop_sidecar", { request }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async runtimeCall(request: RuntimeCallRequest) : Promise<Result<ExternalRuntimeSidecarCallResponse, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("runtime_call", { request }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async runtimeRunCommand(request: ExternalRuntimeCommandRequest) : Promise<Result<ExternalRuntimeCommandResult, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("runtime_run_command", { request }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async runtimeOpenTui(request: RuntimeOpenTuiRequest) : Promise<Result<ExternalRuntimeTuiLaunch, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("runtime_open_tui", { request }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
...
async startupSetLinuxNvidiaWebkitWorkaroundMode(workaroundMode: LinuxNvidiaWebkitWorkaroundMode) : Promise<Result<LinuxDisplayBackendStatus, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("startup_set_linux_nvidia_webkit_workaround_mode", { workaroundMode }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async usrProfilesInitialize(currentSettingsJson: string | null, legacySettingsStorageJson: string | null) : Promise<Result<UsrProfileRuntimeSnapshot, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("usr_profiles_initialize", { currentSettingsJson, legacySettingsStorageJson }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async usrProfilesGetRuntimeSnapshot() : Promise<Result<UsrProfileRuntimeSnapshot, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("usr_profiles_get_runtime_snapshot") };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async usrProfilesPersistActiveSettingsSnapshot(settingsJson: string) : Promise<Result<UsrProfileRuntimeSnapshot, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("usr_profiles_persist_active_settings_snapshot", { settingsJson }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async usrProfilesSwitch(profileId: string, currentSettingsJson: string | null) : Promise<Result<UsrProfileRuntimeSnapshot, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("usr_profiles_switch", { profileId, currentSettingsJson }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async usrProfilesCreate(request: UsrProfileCreateRequest) : Promise<Result<UsrProfileRuntimeSnapshot, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("usr_profiles_create", { request }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async usrProfilesDuplicate(request: UsrProfileDuplicateRequest) : Promise<Result<UsrProfileRuntimeSnapshot, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("usr_profiles_duplicate", { request }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async usrProfilesRename(request: UsrProfileRenameRequest) : Promise<Result<UsrProfileRuntimeSnapshot, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("usr_profiles_rename", { request }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async usrProfilesDelete(request: UsrProfileDeleteRequest) : Promise<Result<UsrProfileRuntimeSnapshot, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("usr_profiles_delete", { request }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
 ...
 */
async windowApplyMode(request: WindowApplyModeRequest) : Promise<Result<null, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("window_apply_mode", { request }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
...
async secondaryWindowOpen(request: SecondaryWindowOpenRequest) : Promise<Result<SecondaryWindowDescriptor, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("secondary_window_open", { request }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async secondaryWindowFocus(windowId: string) : Promise<Result<null, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("secondary_window_focus", { windowId }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async secondaryWindowClose(windowId: string) : Promise<Result<null, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("secondary_window_close", { windowId }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async secondaryWindowDockBack(windowId: string) : Promise<Result<null, string>> {
    try {
    return { status: "ok", data: await TAURI_INVOKE("secondary_window_dock_back", { windowId }) };
} catch (e) {
    if(e instanceof Error) throw e;
    else return { status: "error", error: e  as any };
}
},
async secondaryWindowBeginDragSession(request: SecondaryWindowDragSessionRequest) : Promise<SecondaryWindowDragSessionRequest> {
    return await TAURI_INVOKE("secondary_window_begin_drag_session", { request });
},
async secondaryWindowCompleteDragSession(windowId: string) : Promise<SecondaryWindowDragSessionRequest | null> {
    return await TAURI_INVOKE("secondary_window_complete_drag_session", { windowId });
},
async secondaryWindowGetCurrentDescriptor() : Promise<SecondaryWindowDescriptor | null> {
    return await TAURI_INVOKE("secondary_window_get_current_descriptor");
},
async secondaryWindowListDescriptors() : Promise<SecondaryWindowDescriptor[]> {
    return await TAURI_INVOKE("secondary_window_list_descriptors");
},
...
usrProfileChangedEvent: UsrProfileChangedEvent,
...
usrProfileChangedEvent: "usr-profile-changed-event",
...
export const OVERLAY_SHELL_BLUEPRINTS = [{"description":"Single-workspace overlay shell with chrome, tabs, and optional docked panels.","id":"classic-dock","label":"Classic Dock","navigationModel":"tabs","supportsDualScreen":false,"supportsPanelTabs":true,"supportsPinnedPanels":true,"supportsViewportDock":true,"surfaceStyle":"glass"},{"description":"Canonical dock-graph shell with a navigation rail, sidebar lanes, floating panes, and a panel-style bottom region.","id":"ide-workbench","label":"IDE Workbench","navigationModel":"tabs","supportsDualScreen":false,"supportsPanelTabs":true,"supportsPinnedPanels":true,"supportsViewportDock":true,"surfaceStyle":"solid"},{"description":"Cross-axis media bar with lateral category navigation and deep vertical stacks.","id":"xmb-cross-media","label":"XMB","navigationModel":"cross-axis","supportsDualScreen":false,"supportsPanelTabs":false,"supportsPinnedPanels":false,"supportsViewportDock":false,"surfaceStyle":"glass"},{"description":"Windowed desktop metaphor for classic Macintosh and Hackintosh-inspired shells.","id":"retro-desktop","label":"Retro Desktop","navigationModel":"desktop","supportsDualScreen":false,"supportsPanelTabs":false,"supportsPinnedPanels":true,"supportsViewportDock":false,"surfaceStyle":"skeuomorphic"},{"description":"Grid-first shell optimized for touch-friendly launchers and dashboard surfaces.","id":"tile-start","label":"Tile Start","navigationModel":"tiles","supportsDualScreen":false,"supportsPanelTabs":false,"supportsPinnedPanels":false,"supportsViewportDock":true,"surfaceStyle":"flat"},{"description":"Primary workspace paired with a persistent secondary surface for controls or navigation.","id":"handheld-dual-screen","label":"Handheld Dual Screen","navigationModel":"stacked-dual-pane","supportsDualScreen":true,"supportsPanelTabs":false,"supportsPinnedPanels":true,"supportsViewportDock":false,"surfaceStyle":"pixel"}] as const;
...
export type AssociatedProgram = { name: string; path: string; launchId?: string | null; launchKind?: AssociatedProgramLaunchKind | null; executablePath?: string | null; icon: string | null; isDefault: boolean }
export type AssociatedProgramLaunchKind = "shellHandler" | "executablePath" | "bundleId" | "desktopId"
...
export type DiscoveredRuntimePackage = { manifest: RuntimeManifest; origin: RuntimePackageOrigin; rootId: string }
...
export type ExecutionContextSnapshot = { roots: ExecutionContextRoot[]; activeDirectory: string | null; cwd: string | null; focusedEntry: ExecutionContextEntry | null; selectedEntries: ExecutionContextEntry[]; previewSession: ExecutionContextPreviewSession | null; paneId: string | null; workspaceTabId: string | null; repoContext: ExecutionContextRepoContext | null; activeFileType: FileTypeDescriptor | null; revision: string }
...
export type ExtensionHostFileWatchEvent = { watchId: string; kind: string; paths: string[]; error: string | null }
export type ExtensionHostFileWatchHandle = { watchId: string; path: string; recursive: boolean }
export type ExtensionHostMethodDescriptor = { methodId: string; namespace: string; summary: string; requiredPermissions: string[] }
export type ExtensionHostTaskHandle = { taskId: string; program: string; workingDirectory: string }
export type ExtensionHostTaskOutputEvent = { taskId: string; stream: string; chunk: string }
export type ExtensionHostTaskProgressEvent = { taskId: string; phase: string; program: string | null; workingDirectory: string | null; exitCode: number | null; stream: string | null; error: string | null }
...
export type ExternalRuntimeSidecarStatus = { runtimeId: string; running: boolean; pid: number | null; lastError: string | null; actionIds: string[]; manifestDir: string }
export type ExternalRuntimeTuiLaunch = { runtimeId: string; command: string; args: string[]; workingDirectory: string; label: string; treatZeroExitAsSuccess: boolean }
...
export type FileTypeDescriptor = { id: string; extensions: string[]; fileNames: string[]; languageId: string | null; iconKey: string | null; openBehavior: string; previewOwner: string | null; runtimeAffinity: string | null; editable: boolean }
...
export type FsRuntimeCachePolicy = { dirListCacheTtlMs: number; searchNameIndexCacheTtlMs: number; searchContentIndexCacheTtlMs: number; entrySizeCacheTtlMs: number; entrySizeScanBudgetMs: number; searchContentIndexTotalBytesBudget: number; maxSearchContentFileBytes: number; searchMaxIndexedEntries: number; dirListCacheMaxKeys: number; searchIndexCacheMaxKeys: number; entrySizeCacheMaxKeys: number; searchRequestScopeMaxKeys: number; explorerTaskHistoryMaxEntries: number; driveListCacheTtlMs: number }
...
export type GlobalSearchIndexQueryRequest = { query: string | null; limit: number; offset: number; includeFiles: boolean; includeDirectories: boolean; includeHidden: boolean; extensions: string[]; rootPaths: string[]; exactMatch: boolean; typoTolerance: boolean; minScoreThreshold: number | null; sortKey: GlobalSearchIndexSortKey | null; sortDirection: GlobalSearchIndexSortDirection | null }
export type GlobalSearchIndexQueryResponse = { entries: GlobalSearchResultEntry[]; scannedCandidateCount: number; candidateLimited: boolean }
export type GlobalSearchIndexSortDirection = "asc" | "desc"
export type GlobalSearchIndexSortKey = "relevance" | "modifiedTime" | "name" | "path" | "size"
...
export type HostContextSyncRequest = { snapshot: ExecutionContextSnapshot; isActive: boolean }
export type HostEventEnvelope = { eventId: string; subscriptionId: string | null; topic: string; sequence: number; emittedAtMs: number; delivery: string; scope: HostEventScope; payloadJson: string | null; executionContext: ExecutionContextSnapshot | null; snapshot: boolean }
export type HostEventFilter = { paneId: string | null; workspaceTabId: string | null; pathPrefix: string | null; taskId: string | null; runtimeId: string | null; topicPrefix: string | null }
export type HostEventScope = { paneId: string | null; workspaceTabId: string | null; path: string | null; taskId: string | null; runtimeId: string | null; extensionId: string | null }
export type HostPublishEventRequest = { topic: string; payloadJson: string | null }
export type HostSubscription = { subscriptionId: string; topics: string[]; transport: string; supported: boolean; streamHandle: IpcStreamHandle | null }
export type HostSubscriptionRequest = { topics: string[]; filters: HostEventFilter | null; includeSnapshot: boolean; replayFrom: number | null; deliveryOverride: string | null }
export type HostTopicDescriptor = { topic: string; delivery: string; defaultScope: string; supportsSnapshot: boolean; replayDepth: number; activationTriggers: string[] }
...
export type ImageCutoutCopyToClipboardRequest = { sessionId: string; logicalOutputPath: string | null; filters: ImageCutoutExportFilterState | null; overrideMaskArtifact: IpcArtifactRef | null; overrideMaskDataUrl: string | null }
...
export type ImageCutoutPreviewMask = { artifact: IpcArtifactDescriptor; width: number; height: number }
...
export type ImageCutoutSessionOpenRequest = { inputPath: string | null; inputArtifact: IpcArtifactRef | null; inputDataUrl: string | null; logicalOutputPath: string | null; previewMaxDimension: number | null; config: PythonRuntimeConfig | null; modelId: string | null; backendPreference: string | null; workflowMode: ImageCutoutWorkflowMode }
export type ImageCutoutSessionSnapshot = { sessionId: string; previewMask: ImageCutoutPreviewMask; cutoutPreviewArtifact: IpcArtifactDescriptor; previewWidth: number; previewHeight: number; promptCount: number; canUndo: boolean; canRedo: boolean; diagnostics: ImageCutoutProviderDiagnostics }
export type ImageCutoutStageExportRequest = { sessionId: string; exportMode: ImageCutoutExportMode; logicalOutputPath: string | null; filters: ImageCutoutExportFilterState | null; overrideMaskArtifact: IpcArtifactRef | null; overrideMaskDataUrl: string | null }
...
export type IpcArtifactDescriptor = { id: string; kind: string; resourceRid: number; mediaType: string | null; byteLength: number | null; retention: IpcArtifactRetention; identityKey: string | null; contentRevision: string | null }
export type IpcArtifactRef = { id: string; kind: string; resourceRid: number; mediaType: string | null; identityKey: string | null; contentRevision: string | null }
export type IpcArtifactRetention = "ephemeral" | "persistent"
export type IpcRegisterArtifactPathRequest = { kind: string; filePath: string; mediaType: string | null; retention: IpcArtifactRetention; identityKey: string | null; contentRevision: string | null; deleteOnRelease: boolean }
export type IpcResourceHandle = { rid: number; kind: string }
export type IpcStreamHandle = { id: string; kind: string }
export type IpcStreamPacketMetadata = { streamId: string; sequence: number; emittedAtEpochMs: number; byteLength: number }
...
export type LinuxDisplayBackendStatus = { availableBackends: LinuxDisplayBackend[]; sessionBackend: LinuxDisplayBackend | null; activeBackend: LinuxDisplayBackend | null; preferredBackend: LinuxDisplayBackendPreference; autoX11FallbackActive: boolean; nvidiaGpuDetected: boolean; nvidiaWebkitWorkaroundMode: LinuxNvidiaWebkitWorkaroundMode }
/**
...
export type MessageRingFrameMetadata = { sequence: number; emittedAtEpochMs: number; byteLength: number; frameIndex: number; frameCount: number; chunked: boolean }
export type MessageRingOverflowPolicy = "drop-oldest"
export type MessageRingOverflowSnapshot = { overflowed: boolean; overflowCount: number; droppedMessages: number; droppedBytes: number; firstDroppedSequence: number | null; latestDroppedSequence: number | null }
export type MessageRingPolicy = { enabled: boolean; maxMessages: number; maxBytes: number; maxFrameBytes: number; replayResponseLimit: number; overflowPolicy: MessageRingOverflowPolicy }
export type MessageRingReplayGap = { requestedSequence: number; oldestRetainedSequence: number; skippedMessages: number }
export type MessageRingTelemetry = { retainedMessages: number; retainedBytes: number; oldestSequence: number | null; nextSequence: number; totalWrittenMessages: number; totalWrittenBytes: number; chunkedMessages: number; overflow: MessageRingOverflowSnapshot }
export type MessageRingWriteOutcome = { metadata: MessageRingFrameMetadata; retained: boolean; evictedMessages: number; evictedBytes: number; overflow: MessageRingOverflowSnapshot }
export type MessageStreamsPolicy = { enabled: boolean; telemetryEnabled: boolean; defaultTopic: MessageRingPolicy; terminal: MessageRingPolicy; taskOutput: MessageRingPolicy; telemetry: MessageRingPolicy }
...
export type PathIndexAccelerationEnableRequest = { driveRoot: string | null; autoIndex: boolean | null; journalMaximumSizeBytes: number | null; journalAllocationDeltaBytes: number | null }
export type PathIndexAccelerationEnableResponse = { serviceUrl: string; databasePath: string; profileRegistered: boolean; journalEnsured: boolean; taskId: string | null; driveRoot: string | null; state: string }
export type PathIndexAccelerationInstallServiceRequest = { daemonPath: string | null }
export type PathIndexAccelerationInstallServiceResponse = { serviceName: string; serviceUrl: string; daemonPath: string; launchedElevated: boolean; state: string }
export type PathIndexAccelerationJobStatus = { taskId: string; driveRoot: string; state: string; lastError: string | null }
export type PathIndexAccelerationRebuildRequest = { driveRoot: string; journalMaximumSizeBytes: number | null; journalAllocationDeltaBytes: number | null }
export type PathIndexAccelerationStatus = { enabled: boolean; platformSupported: boolean; serviceName: string; serviceUrl: string; installed: boolean; running: boolean; processElevated: boolean; profileRegistered: boolean; databasePath: string; volumes: PathIndexAccelerationVolumeStatus[]; activeJobs: PathIndexAccelerationJobStatus[]; lastError: string | null }
export type PathIndexAccelerationVolumeStatus = { volumeKey: string; driveRoot: string; journalId: number | null; lastUsn: number | null; lowestValidUsn: number | null; source: string; state: string; entryCount: number; directoryCount: number; fileCount: number; lastIndexedAtMs: number | null; lastError: string | null }
export type PathIndexActiveTask = { rootKey: string; taskId: string; startedAtMs: number }
export type PathIndexListDirectoryRequest = { path: string; showHidden: boolean }
export type PathIndexRootStatus = { rootPath: string; rootKey: string; volumeKey: string; state: string; source: string; entryCount: number; directoryCount: number; fileCount: number; lastIndexedAtMs: number | null; lastError: string | null; journalId: number | null; lastUsn: number | null }
export type PathIndexSearchMatchMode = "prefix" | "contains"
export type PathIndexSearchRequest = { rootPath: string | null; query: string; limit: number | null; includeHidden: boolean | null; matchMode: PathIndexSearchMatchMode | null }
export type PathIndexStartRequest = { rootPath: string; forceRebuild: boolean | null; recursiveFallback: boolean | null }
export type PathIndexStartResponse = { taskId: string | null; rootPath: string; rootKey: string; state: string; source: string }
export type PathIndexStatus = { enabled: boolean; databasePath: string; activeTasks: PathIndexActiveTask[]; roots: PathIndexRootStatus[]; lastError: string | null }
...
export type PythonSidecarActionResponse = { runtimeStatus: PythonRuntimeStatus; sidecar: PythonSidecarStatus; requestId: string; actionId: string; resultJson: string; outputArtifacts: IpcArtifactDescriptor[]; outputArtifactTokens: (string | null)[]; resourceHandles: IpcResourceHandle[] }
 ...
 */
"node-script"
export type RuntimeDiscoveryRootDto = { rootId: string; origin: RuntimePackageOrigin; directory: string }
/**
 ...
 * canonical enum.
 */
export type RuntimeKind = "native-sidecar" | "native-command" | "native-tui" | "wasm-panel" | "wasm-worker" | "vscode-bridge"
export type RuntimeListPackagesRequest = { 
/**
 ...
 */
additionalRoots?: RuntimeDiscoveryRootDto[] }
export type RuntimeListPackagesResponse = { packages: DiscoveredRuntimePackage[]; builtinRoot: string | null; managedRoot: string | null }
/**
 ...
 */
export type RuntimeManifest = { id: string; displayName: string; language: string; kind: RuntimeKind; compiler: RuntimeCompiler; 
/**
 ...
 */
entry: string | null; watchGlobs: string[]; env: Partial<{ [key in string]: string }>; args: string[]; workingDirectory: string | null; permissions: RuntimePackagePermissions; panel: RuntimePanelConfig | null; command: RuntimeCommandConfig | null; sidecar: RuntimeSidecarConfig | null; tui: RuntimeTuiConfig | null; 
/**
 * Source signature digest the cache uses to invalidate stale builds.
 */
sourceSignature: string }
export type RuntimeOpenTuiRequest = { runtimeId: string }
export type RuntimePackageOrigin = "builtin" | "managed-content"
/**
 ...
 */
export type RuntimePackagePermissions = { 
/**
...
export type RuntimePackagePreset = { id: string; label: string; description?: string; packages?: string[] }
export type RuntimePanelConfig = { 
/**
...
export type RuntimePreparePackageRequest = { runtimeId: string; 
/**
...
export type RuntimePreparePackageResponse = { runtimeId: string; artifactPath: string; artifactKind: string; cacheKey: string; cacheHit: boolean; toolchainVersion: string; mode: string; target: string; sourceSignature: string; stdout: string; stderr: string }
export type RuntimeSidecarConfig = { 
/**
 ...
 */
packagePresets: RuntimePackagePreset[]; 
/**
...
export type RuntimeToolchainStatus = { go: ToolchainProbe; tinygo: ToolchainProbe; cargo: ToolchainProbe; rustc: ToolchainProbe; wasmBindgen: ToolchainProbe; cc: ToolchainProbe; python: ToolchainProbe; kain: ToolchainProbe; node: ToolchainProbe; manifestPath: string | null; kainManifestPath: string | null }
 ...
 */
treatZeroExitAsSuccess?: boolean }
...
export type SecondaryWindowDescriptor = { windowId: string; windowLabel: string; surfaceKind: SecondaryWindowSurfaceKind; presentation: SecondaryWindowPresentation; title: string; initialSize: SecondaryWindowSize; minSize: SecondaryWindowSize; rememberBounds: boolean; sourceWindowLabel: string | null; dockTarget: SecondaryWindowDockTarget | null; payloadJson: string | null }
export type SecondaryWindowDockTarget = { surfaceId: string; restorePlacement: string | null }
export type SecondaryWindowDragSessionRequest = { sourceWindowId: string; sourceWindowLabel: string | null; surfaceId: string | null; payloadJson: string | null }
export type SecondaryWindowOpenRequest = { windowId: string; surfaceKind: SecondaryWindowSurfaceKind; presentation: SecondaryWindowPresentation; title: string; initialSize: SecondaryWindowSize | null; minSize: SecondaryWindowSize | null; sourceWindowLabel: string | null; dockTarget: SecondaryWindowDockTarget | null; payloadJson: string | null }
export type SecondaryWindowPresentation = "frameless-widget" | "tool-window"
export type SecondaryWindowSize = { width: number; height: number }
export type SecondaryWindowSurfaceKind = "explorer-picker" | "file-operations" | "panel" | "plugin-panel" | "action-widget" | "lookdev"
...
export type TelemetrySessionStatus = { config: TelemetryConfig; session_id: string; trace_directory: string; current_file_path: string | null; session_file_paths: string[]; recent_record_count: number; recent_records_telemetry: MessageRingTelemetry; recent_records_overflow: MessageRingOverflowSnapshot }
...
export type ThemeTokenKind = "color" | "typography" | "spacing" | "radius" | "border" | "shadow" | "opacity" | "blur" | "geometry" | "layer" | "motion" | "interaction"
export type ToolchainProbe = { id: string; installed: boolean; version: string | null; executablePath: string | null; error: string | null }
export type UsrManagedContentDirectoryStack = { laneId: string; profileMode: UsrProfileLaneMode; directories: string[]; baselineDirectory: string; sharedRootDirectory: string | null; defaultProfileDirectory: string | null; activeProfileDirectory: string | null; bundledDirectory: string | null; writableDirectory: string }
export type UsrProfileChangedEvent = { snapshot: UsrProfileRuntimeSnapshot }
export type UsrProfileCreateRequest = { name: string; profileId: string | null; activate: boolean; seedSettingsJson: string | null }
export type UsrProfileDeleteRequest = { profileId: string; fallbackProfileId: string | null }
export type UsrProfileDuplicateRequest = { sourceProfileId: string; name: string; profileId: string | null; activate: boolean; currentSettingsJson: string | null }
export type UsrProfileLaneMode = "shared-root" | "profile-overlay"
export type UsrProfileRenameRequest = { profileId: string; name: string }
export type UsrProfileRuntimeSnapshot = { activeProfileId: string; profilesRoot: string; sharedSettingsPath: string; sharedSettingsJson: string; activeProfileSettingsPath: string; activeProfileSettingsJson: string; effectiveSettingsJson: string; profiles: UsrProfileSummary[]; managedContentDirectoryStacks: UsrManagedContentDirectoryStack[] }
export type UsrProfileSummary = { id: string; name: string; overrideSlices: string[]; createdAtMs: number; updatedAtMs: number; directoryPath: string; settingsPath: string; isActive: boolean }
...
export type WindowApplyModeRequest = { decorations: boolean; alwaysOnTop: boolean; shadow: boolean; skipTaskbar: boolean; x: number; y: number; width: number; height: number; minWidth: number; minHeight: number; maxWidth: number; maxHeight: number }
