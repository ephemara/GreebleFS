...
export type StoragePathSummary = { path: string; name: string; kind: StorageNodeKind; bytes: number; fileCount: number; directoryCount: number; depth: number }
export type StorageScanStartResponse = { scanId: string }
export type StorageScanStatus = { scanId: string; rootPath: string; rootName: string; scannedFileCount: number; scannedDirectoryCount: number; totalBytes: number; errorCount: number; sampleErrors: string[]; completed: boolean; cancelled: boolean; error: string | null; currentPath: string | null; elapsedMs: number; tree: StorageTreeNode | null; largestEntries: StoragePathSummary[] }
export type StorageTreeNode = { path: string; name: string; kind: StorageNodeKind; bytes: number; fileCount: number; directoryCount: number; children: StorageTreeNode[] }
