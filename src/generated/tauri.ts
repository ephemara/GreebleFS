...
export type ImageCutoutCopyToClipboardRequest = { sessionId: string; logicalOutputPath: string | null; filters: ImageCutoutExportFilterState | null }
...
export type ImageCutoutStageExportRequest = { sessionId: string; exportMode: ImageCutoutExportMode; logicalOutputPath: string | null; filters: ImageCutoutExportFilterState | null }
