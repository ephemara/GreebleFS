...
export type VideoEngineStateSnapshot = { ready: boolean; engineError: string | null; loadedPath: string | null; loadedName: string | null; durationSeconds: number; widthPx: number | null; heightPx: number | null; frameRate: number | null; hasAudioTrack: boolean; currentTimeSeconds: number; isPlaying: boolean; isLoading: boolean; previewFramePath: string | null; previewFrameTimestampSeconds: number | null; cachedFrameCount: number; playbackBackend: VideoPlaybackBackend; loopRegion: VideoEngineLoopRegion; audioTransportReady: boolean; audioTransportError: string | null }
export type VideoPlaybackBackend = "ffmpegFrameSequence"
