...
pub fn binding_manifest() -> YaziBindingManifest {
    YaziBindingManifest {
        ...
        entries: vec![
            manifest_entry(
                YaziCrateName::YaziActor,
                YaziBindingStatus::Internal,
                &[],
                &["actor command internals"],
            ),
            manifest_entry(
                YaziCrateName::YaziAdapter,
                YaziBindingStatus::Planned,
                &[],
                &["adapter and image bridge surface planned"],
            ),
            manifest_entry(
                YaziCrateName::YaziBinding,
                YaziBindingStatus::Internal,
                &[],
                &["Lua binding internals"],
            ),
            manifest_entry(
                YaziCrateName::YaziBoot,
                YaziBindingStatus::Planned,
                &[],
                &["boot/runtime handshake surface planned"],
            ),
            manifest_entry(
                YaziCrateName::YaziBuild,
                YaziBindingStatus::Internal,
                &[],
                &["build helper crate"],
            ),
            manifest_entry(
                YaziCrateName::YaziCli,
                YaziBindingStatus::Internal,
                &[],
                &["CLI-only surface"],
            ),
            manifest_entry(
                YaziCrateName::YaziCodegen,
                YaziBindingStatus::Internal,
                &[],
                &["codegen helper crate"],
            ),
            manifest_entry(
                YaziCrateName::YaziConfig,
                YaziBindingStatus::Planned,
                &[],
                &["config/theme bridge surface planned"],
            ),
            manifest_entry(
                YaziCrateName::YaziCore,
                YaziBindingStatus::Internal,
                &[],
                &["runtime state internals"],
            ),
            manifest_entry(
                YaziCrateName::YaziDds,
                YaziBindingStatus::Planned,
                &[],
                &["DDS payload bridge surface planned"],
            ),
            manifest_entry(
                YaziCrateName::YaziEmulator,
                YaziBindingStatus::Planned,
                &[],
                &["terminal emulator bridge surface planned"],
            ),
            manifest_entry(
                YaziCrateName::YaziFfi,
                YaziBindingStatus::Internal,
                &[],
                &["FFI handle internals"],
            ),
            manifest_entry(
                YaziCrateName::YaziFm,
                YaziBindingStatus::Internal,
                &[],
                &["full TUI app crate"],
            ),
            manifest_entry(
                ...
                &[
                    ...
                    "YaziFsSortFallback",
                    "YaziFsErrorDto",
                    "YaziFsFolderStageDto",
                ],
                &["file explorer sorting and stage contracts exported"],
            ),
            manifest_entry(
                YaziCrateName::YaziMacro,
                YaziBindingStatus::Internal,
                &[],
                &["macro crate"],
            ),
            manifest_entry(
                YaziCrateName::YaziPacking,
                YaziBindingStatus::Planned,
                &[],
                &["archive/package bridge surface planned"],
            ),
            manifest_entry(
            ...
            manifest_entry(
                YaziCrateName::YaziPlugin,
                YaziBindingStatus::Planned,
                &[],
                &["plugin runtime bridge surface planned"],
            ),
            manifest_entry(
                YaziCrateName::YaziProxy,
                YaziBindingStatus::Planned,
                &[],
                &["proxy bridge surface planned"],
            ),
            manifest_entry(
            ...
            manifest_entry(
                YaziCrateName::YaziSftp,
                YaziBindingStatus::Planned,
                &[],
                &["SFTP bridge surface planned"],
            ),
            manifest_entry(
                YaziCrateName::YaziShared,
                YaziBindingStatus::Planned,
                &[],
                &["shared URL/data bridge surface planned"],
            ),
            manifest_entry(
                YaziCrateName::YaziShim,
                YaziBindingStatus::Internal,
                &[],
                &["platform shim internals"],
            ),
            manifest_entry(
                YaziCrateName::YaziTerm,
                YaziBindingStatus::Planned,
                &[],
                &["terminal presentation bridge surface planned"],
            ),
            manifest_entry(
                YaziCrateName::YaziTty,
                YaziBindingStatus::Internal,
                &[],
                &["TTY internals"],
            ),
            manifest_entry(
                YaziCrateName::YaziVfs,
                YaziBindingStatus::Planned,
                &[],
                &["VFS service bridge surface planned"],
            ),
            manifest_entry(
                YaziCrateName::YaziWatcher,
                YaziBindingStatus::Planned,
                &[],
                &["watcher event bridge surface planned"],
            ),
            manifest_entry(
                YaziCrateName::YaziWidgets,
                YaziBindingStatus::Planned,
                &[],
                &["widget layout bridge surface planned"],
            ),
        ],
    }
}
