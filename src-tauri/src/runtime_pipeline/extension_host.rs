    ...
    ExtensionHostApiSchema {
        ...
        methods: vec![
            ...
            build_method_descriptor(
                "terminal.spawn",
                "terminal",
                "Spawn one embedded PTY terminal session owned by the host.",
                &["terminalInteraction"],
            ),
            build_method_descriptor(
                "terminal.write",
                "terminal",
                "Write one chunk of input into one embedded PTY terminal session.",
                &["terminalInteraction"],
            ),
            build_method_descriptor(
                "terminal.write_many",
                "terminal",
                "Broadcast one or more input writes into embedded PTY terminal sessions.",
                &["terminalInteraction"],
            ),
            build_method_descriptor(
                "terminal.resize",
                "terminal",
                "Resize one embedded PTY terminal session by rows and columns.",
                &["terminalInteraction"],
            ),
            build_method_descriptor(
                "terminal.kill",
                "terminal",
                "Terminate one embedded PTY terminal session.",
                &["terminalInteraction"],
            ),
            build_method_descriptor(
                "terminal.open_output_stream",
                "terminal",
                "Open the host IPC output stream for one embedded PTY terminal session.",
                &["terminalInteraction"],
            ),
            build_method_descriptor(
                "terminal.register_shell_integration",
                "terminal",
                "Register shell integration metadata for one embedded PTY terminal session.",
                &["terminalInteraction"],
            ),
            build_method_descriptor(
                "terminal.sync_cwd",
                "terminal",
                "Request a working-directory sync for one embedded PTY terminal session.",
                &["terminalInteraction"],
            ),
            build_method_descriptor(
                "terminal.set_prompt_state",
                "terminal",
                "Update prompt-state metadata for one embedded PTY terminal session.",
                &["terminalInteraction"],
            ),
            build_method_descriptor(
